  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="p-8 sm:p-10 text-center rounded-lg border border-gray-200 group hover:border-blue-300 hover:shadow-lg transition-all"
              >
                <div className="mb-4 inline-flex">
                  <div className="flex items-center justify-center h-14 w-14 rounded-xl bg-blue-100 group-hover:bg-blue-200 transition-all">
        ...
        <div className="mt-12 sm:mt-16 rounded-xl bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-200 p-8 sm:p-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="inline-flex items-center justify-center flex-shrink-0 h-6 w-6 rounded-full bg-green-100 text-green-700 text-sm font-semibold">✓</span>
